# Unsloth-Intel-Arc
I was unable to find a working Dockerfile to run Unsloth Studio with an Intel Arc GPU and my attempts to install it on my system became a Python dependency circle of hell. Hopefully this helps anyone with that would like to run Unsloth on their PC with an Intel Arc GPU.
